...
train_black_edu_mean = 3.6
train_hispanic_edu_mean = 3.9
train_asian_edu_mean = 3.4
train_white_edu_mean = 3.4

train_black_wh_mean = 3.7
train_hispanic_wh_mean = 3.8
train_asian_wh_mean = 3.6
train_white_wh_mean = 3.6

train_black_sl_mean = 3.3
train_hispanic_sl_mean = 3.4
train_asian_sl_mean = 3.2
train_white_sl_mean = 3.2
...
test_black_edu_mean = 4.6
test_hispanic_edu_mean = 4.9
test_asian_edu_mean = 3.4
test_white_edu_mean = 3.4

test_black_wh_mean = 4.7
test_hispanic_wh_mean = 4.8
test_asian_wh_mean = 3.6
test_white_wh_mean = 3.6

test_black_sl_mean = 4.3
test_hispanic_sl_mean = 4.4
test_asian_sl_mean = 3.2
test_white_sl_mean = 3.2
