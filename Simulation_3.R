...
# Author : Yiran Jia 
# Date: Sep 11th, 2023 
# Version: Sample imbalance with correct model. Here we simulate based on the assumption that the imbalance occur
...
black_edu_mean = 3.6
hispanic_edu_mean = 3.9
asian_edu_mean = 3.4
white_edu_mean = 3.4

black_wh_mean = 3.7
hispanic_wh_mean = 3.8
asian_wh_mean = 3.6
white_wh_mean = 3.6

black_sl_mean = 3.3
hispanic_sl_mean = 3.4
asian_sl_mean = 3.2
white_sl_mean = 3.2
