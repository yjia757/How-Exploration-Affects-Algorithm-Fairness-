...
# Author : Yiran Jia 
# Date: Sep 12th, 2023 
# Version: Natural imbalance with incorrect model. Here we simulate based on the assumption that the imbalance occur
# in the underlying distribution, and use a non-linear logistic model to simulate the hiring outcome from the features 
...
# ## Method 2 of generating hiring potential 
# # Update the data
# fix_data_pre_mino_high_1617 <- fix_data_pre_mino_high_1617 %>%
#   mutate(
...
# Method 3 of generating hiring potential
# Custom function to calculate hiring probability
...
n_rounds <- floor(n1819/round_size - 22)
